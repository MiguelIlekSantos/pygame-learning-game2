...
class Game:
    ...
    def run(self):
        while True:
            ...
            self.clouds.update()
            self.clouds.render(self.smallScreen, offset=render_scroll)

            self.tilemap.render(self.smallScreen, offset = render_scroll)
            
            self.player.update(self.tilemap, (self.movement[1] - self.movement[0], 0))
            self.player.render(self.smallScreen, offset = render_scroll)
